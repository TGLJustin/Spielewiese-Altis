/*
	...
	option is presented.
*/
private["_appleZones","_peachZones","_heroinZones","_cocaineZones","_weedZones","_oilZones","_hopfen"];
...
//Create hopfen zones
{
	...
	_zone setTriggerArea[90,90,0,false];
	_zone setTriggerActivation["CIV","PRESENT",true];
	_zone setTriggerStatements["player in thislist","LIFE_Action_Hopfen = player addAction[(localize ""STR_Gather_Hopfen""),life_fnc_gather,'',0,false,false,'','!life_action_gather'};","player removeAction LIFE_Action_Hopfen;"];
