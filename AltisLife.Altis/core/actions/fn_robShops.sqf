...
*/
private["_robber","_shop","_kassa","_ui","_progress","_pgText","_cP","_rip","_pos","_vault"];
...
if (_rip) exitWith { hint "Überfall bereits im Gange!" };
...
if(_robber distance _shop > 10.5) exitWith { deleteMarker "Marker200"; _shop switchMove ""; hint "Du hast dich zu weit entfernt (10m). Raub ist fehlgeschlagen!"; 5 cutText ["","PLAIN"]; _rip = false; };
5 cutText ["","PLAIN"];
