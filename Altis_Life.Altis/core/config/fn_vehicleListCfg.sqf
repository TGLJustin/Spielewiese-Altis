...
{	
	...
	case "civ_air_1":
	{
		...
		[
			...
			["B_Heli_Transport_03_F",900000],
			["O_Heli_Transport_04_box_F",900000],
			["O_Heli_Transport_04_covered_F",900000],
			["O_Heli_Transport_04_fuel_F",900000],
			["O_Heli_Transport_04_medevac_F",900000],
			["O_Heli_Transport_04_repair_F",900000]
		];
	};
