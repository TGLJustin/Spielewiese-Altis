...
switch(_type) do
{
	...
	case "390": {_type = ["Öffentlicher Rausch",15000]};
	case "919": {_type = ["Organ Handel",200000]};

  case "1": {_type = ["Fahren ohne Führerschein",10000]};
  ...
  case "5": {_type = ["Überhöhte Geschwindigkeit",5000]};
  case "6": {_type = ["Gefährliche Fahrweise",5000]};
  ...
  case "18": {_type = ["Belästigung eines Polizisten",9000]};
  ...
  case "34": {_type = ["Angriff/Belagerung von Hauptstädten",500000]};
  ...
  case "40": {_type = ["Handel mit exotischen Gütern",70000]};
  ...
  case "506": {_type = ["Geblitzt",30401]};
  case "507": {_type = ["Geblitzt",30402]};
